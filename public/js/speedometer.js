...
$.fn.speedometer = function (userPref) {
  ...
  this.defaultProperty = {
    ...
    gagueLabel          : 'Label',        /**Label on guage Face*/
    title               : 'Title'             /**Label on guage Face*/
  }
  ...
  this.setCssProperty = function(){
    var tempStyleVar = [
      '<style>',
        ...
        '}',
        '#' + this.parentElemId + ' .meterTitle{',
          'top  :'+( parseInt(speedPositionTxtTL)-50 ) + 'px;',
        '}',
  ...
  this.createIndicators = function(){
    ...
    var speedNobe = [
      '<div class="speedNobe">',
        '<div></div>',
      '</div>',
      '<div class="meterTitle">'+self.defaultProperty.title+'</div>',
      '<div class="speedPosition"></div>'
    ].join();

    speedNobe = speedNobe.replace(/,/g, '');
  ...
  this.changePosition = function (){
    ...
    self.parentElem.find(".speedPosition").html("<div class='meter-center'>"+centerVal+"</div>");
    self.parentElem.find(".meter-center").after('<div class="meter-label">'+self.defaultProperty.gagueLabel+'</div>');
